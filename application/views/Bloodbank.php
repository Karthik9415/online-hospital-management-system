        ...
        <div class="container">
            <div class="about-main" style="margin-left: 280px">
                <div class="about-right">
                    <h3 class="subheading-w3-agile">BLOOD BANK</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            <form action="<?php echo base_url()?>bloodbank/blood" method="post">
                                <input class="form-control mb-3" type="text" placeholder="Doner Name" name="name" required="">
                                ...
                                <select class="form-control mb-3" name="bloodgroup">
                                ...
                                <select class="form-control mb-3" name="unit">
                                    <option value="1Unit">1Unit</option>
                                    <option value="2Unit">2Unit</option>
                                    <option value="3Unit">3Unit</option>
                                    <option value="4Unit">4Unit</option>
                                </select>
