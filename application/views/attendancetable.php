...
<!--                    </a>-->
<!--                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">-->
<!--                        <a class="dropdown-item" href="outpatient">OUTPATIENT</a>-->
<!--                        <div class="dropdown-divider"></div>-->
<!--                        <a class="dropdown-item" href="outpatienttable">DETAILS</a>-->
<!--                    </div>-->
<!--                </li>-->
                <li class="nav-item active  mr-3 mt-lg-0 mt-3">
                ...
                <div class="col-md-12">
                    <table class="table table-striped">
                        ...
                        foreach($nurs as $nur) {
                            ...
                            <tbody>
                            <tr>
                                <td><?php echo $nur['nid']?></td>
                                <td><?php echo $nur['name']?></td>
                                <td><?php echo $nur['date']?></td>
                                <td><?php echo $nur['attendance']?></td>
                            </tr>
