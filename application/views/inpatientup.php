        ...
        <div class="container">
            <div class="about-main" style="margin-left: 280px">
                <div class="about-right">
                    <h3 class="subheading-w3-agile">IN PATIENTS UPDATE</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            ...
                            foreach ($quans as $quan) {
                                ?>
                                <form action="<?php echo base_url()?>inpatientup/upt" method="post">

                                    <input class="form-control mb-3" type="text" placeholder="Patient Name" name="pid" value="<?php echo $quan['id']?>"
                                           required="">
                                    <input class="form-control mb-3" type="text" placeholder="Patient Name" name="pname" value="<?php echo $quan['pname']?>"
                                           required="">
                                    <input class="form-control mb-3" type="text" placeholder="Patient Address" value="<?php echo $quan['address']?>"
                                           name="address" required="">
                                    <input class="form-control mb-3" type="text" placeholder="Room Number" name="rno" value="<?php echo $quan['rno']?>"
                                           required="">
                                    <input class="form-control mb-3" type="text" placeholder="Room Number" name="nname" value="<?php echo $quan['nname']?>"
                                           required="">
                                    <input class="form-control mb-3" type="text" placeholder="Test Details" value="<?php echo $quan['testdetails']?>"
                                           name="testdetails" required="">
                                    <input class="form-control mb-3" type="text" placeholder="Medicine Details" value="<?php echo $quan['medicinedetails']?>"
                                           name="medicinedetails" required="">
                                    <input class="form-control date mb-3" name="amount" placeholder="Amount" value="<?php echo $quan['amount']?>"
                                           required="">
