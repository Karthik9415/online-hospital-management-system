        ...
        <div class="container">
            <div class="about-main" style="margin-left: 280px">
                <div class="about-right">
                    <h3 class="subheading-w3-agile">NURSE ATTENTANCE</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            <form action="<?php echo base_url()?>nurseatten/nurse" method="post">
                                <input class="form-control mb-3" type="text" placeholder="Nurse Id" name="nid" required="">
                                <input class="form-control mb-3" type="text" placeholder="Nurse Name" name="name" required="">
                                <select class="form-control mb-3" name="attendance">
                                    <option value="">Attentance</option>
