        ...
        <div class="container">
            <div class="about-main" style="margin-left: 280px">
                <div class="about-right">
                    <h3 class="subheading-w3-agile" align="center">OPERATION</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            <form action="<?php echo base_url()?>operation/operation" method="post">
                                ...
                                <input class="form-control mb-3" type="date" placeholder="date" name="date" required="">
                                <input class="form-control mb-3" type="time" placeholder="time" name="time" required="">
                                <select class="form-control mb-3" name="dname">
