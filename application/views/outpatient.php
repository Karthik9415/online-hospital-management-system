        ...
        <div class="container">
            <div class="about-main" style="margin-left: 280px">
                <div class="about-right">
                    <h3 class="subheading-w3-agile">out patients</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            <form action="<?php echo base_url()?>outpatient/outp" method="post">

                                <select class="form-control mb-3" name="dname" id="dname" onchange="get()">
                                    <option value="dr.naveen">Dr.naveen</option>
                                    <option value="dr.gowtham">Dr.gowtham</option>
                                    <option value="dr.pandi">Dr.pandi</option>
                                </select>
                                <input class="form-control mb-3" type="text" placeholder="Token Id" name="tid" required="" id="gow">
                                <input class="form-control mb-3" type="text" placeholder="Patient Id" name="pid" required="">
                                ...
                                <input type="date" class="form-control mb-3" type="text" placeholder="Date" name="date" required="">
