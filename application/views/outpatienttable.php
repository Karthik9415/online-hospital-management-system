...
<div class="about">
    <div class="abt-layer">
        <div class="container">
            ...
            <h3 align="center">OUTPATIENTS DETAILS</h3><br>
                ...
                <div class="col-md-12">
                    <table class="table table-striped">
                        ...
                        foreach($runs as $run) {
                            ...
                            <tbody>
                            <tr>
                                <td><?php echo $run['pid']?></td>
                                <td><?php echo $run['pname']?></td>
                                <td><?php echo $run['tid']?></td>
                                <td><?php echo $run['phone']?></td>
                                <td><?php echo $run['dname']?></td>
                                <td><?php echo $run['date']?></td>
                                <td><a href="<?php echo base_url()?>outpatientup?id=<?php echo $run['id']?>"> Edit</a></td>
                                <td><a href="<?php echo base_url()?>outpatientup/dele1?id=<?php echo $run['id']?>">Delete</a></td>
                            </tr>
